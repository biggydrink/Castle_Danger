...
Note: This version of the file does not use the colorama module. I've commented out lines that used it and have
replaced them with new lines that do the exact same thing, but without using colorama.
"""
...
class Character:
    ...
    and so we can easily access each item object's data using it's name as a reference. This comes in handy when
...
def attack(arg=None):
    ...
    if arg != None:
        ...
        while player.hp > 0 and monster_attacked.hp > 0:
            ...
            if monster_damage > 18: mobattackstring = "HARD!!"
            ...
            if player_damage > 18: playerattackstring = "HARD!!"
